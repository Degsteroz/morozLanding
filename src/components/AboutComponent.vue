<template>
  <div class='aboutContainer'>
    ...
    <div class='about__firstParagraph'>{{firstParagraph}}</div>
...
const title = 'Обо мне'
const firstParagraph = 'Меня зовут Маша Мороз. Я портретный фотограф. Люблю людей, их аутентичность ' +
